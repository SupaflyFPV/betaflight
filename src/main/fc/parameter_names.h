...
#define PARAM_NAME_RC_SMOOTHING_CUTOFF_MIN "rc_smoothing_cutoff_min"
#define PARAM_NAME_RC_SMOOTHING_CUTOFF_MAX "rc_smoothing_cutoff_max"
#define PARAM_NAME_RC_SMOOTHING_SENSITIVITY "rc_smoothing_sensitivity"
