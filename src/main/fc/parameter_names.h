...
#define PARAM_NAME_RC_DYNAMIC_SMOOTHING_CUTOFF_MIN "rc_dynamic_smoothing_cutoff_min"
#define PARAM_NAME_RC_DYNAMIC_SMOOTHING_CUTOFF_MAX "rc_dynamic_smoothing_cutoff_max"
#define PARAM_NAME_RC_DYNAMIC_SMOOTHING_SENSITIVITY "rc_dynamic_smoothing_sensitivity"
