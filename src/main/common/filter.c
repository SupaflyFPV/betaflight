...
static const float firDtermCoeffs[FIR_DTERM_TAP_COUNT] = {
    0.04718316f,  0.00413000f,  0.00566817f,  0.00828570f,  0.01163404f,
    0.01609121f,  0.02111039f,  0.02674549f,  0.03255178f,  0.03844244f,
    0.04380228f,  0.04884161f,  0.05273306f,  0.05591415f,  0.05766141f,
    0.05841023f,  0.05766141f,  0.05591415f,  0.05273306f,  0.04884161f,
    0.04380228f,  0.03844244f,  0.03255178f,  0.02674549f,  0.02111039f,
    0.01609121f,  0.01163404f,  0.00828570f,  0.00566817f,  0.00413000f,
    0.04718316f
};
