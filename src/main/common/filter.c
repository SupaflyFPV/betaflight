...
static const float firDtermCoeffs[FIR_DTERM_TAP_COUNT] = {
    0.00487610f,  0.00549536f,  0.00731696f,  0.01026503f,  0.01421370f,
    0.01899251f,  0.02439396f,  0.03018257f,  0.03610533f,  0.04190284f,
    0.04732082f,  0.05212137f,  0.05609351f,  0.05906258f,  0.06089794f,
    0.06151884f,  0.06089794f,  0.05906258f,  0.05609351f,  0.05212137f,
    0.04732082f,  0.04190284f,  0.03610533f,  0.03018257f,  0.02439396f,
    0.01899251f,  0.01421370f,  0.01026503f,  0.00731696f,  0.00549536f,
    0.00487610f
};
