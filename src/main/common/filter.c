...
static const float firDtermCoeffs[FIR_DTERM_TAP_COUNT] = {
    0.01651046f,  0.00345738f,  0.00496027f,  0.00745747f,  0.01101526f,
    0.01560905f,  0.02109695f,  0.02728629f,  0.03388874f,  0.04063833f,
    0.04716963f,  0.05317826f,  0.05826381f,  0.06216741f,  0.06458572f,
    0.06542993f,  0.06458572f,  0.06216741f,  0.05826381f,  0.05317826f,
    0.04716963f,  0.04063833f,  0.03388874f,  0.02728629f,  0.02109695f,
    0.01560905f,  0.01101526f,  0.00745747f,  0.00496027f,  0.00345738f,
    0.01651046f
};
