...
{
    biquadFilterInitLPFWithQ(filter, filterFreq, refreshRate, BIQUAD_Q_BUTTERWORTH);
}
...
{
    biquadFilterUpdate(filter, filterFreq, refreshRate, BIQUAD_Q_BUTTERWORTH, FILTER_LPF, 1.0f);
}
