...
typedef struct pidProfile_s {
    ...
    uint16_t pterm_lowpass_hz;              // Lowpass filter cutoff for all P terms (0 to disable)
...
typedef struct pidRuntime_s {
    ...
    filterApplyFnPtr ptermLowpassApplyFn;
    pt1Filter_t ptermLowpass[XYZ_AXIS_COUNT];
