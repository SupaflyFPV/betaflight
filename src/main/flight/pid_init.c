...
void pidInitConfig(const pidProfile_t *pidProfile)
{
    ...
    pidRuntime.thrustLinearizationLow = pidProfile->thrustLinearizationLow / 100.0f;
    pidRuntime.thrustLinearizationHigh = pidProfile->thrustLinearizationHigh / 100.0f;
#endif
