...
void pidInitConfig(const pidProfile_t *pidProfile)
{
    ...
    pidRuntime.tpaMultiplierP = (pidProfile->tpa_p_rate / 100.0f) / (1.0f - pidRuntime.tpaBreakpoint);
    pidRuntime.tpaMultiplierD = (pidProfile->tpa_d_rate / 100.0f) / (1.0f - pidRuntime.tpaBreakpoint);
    ...
    pidRuntime.tpaLowMultiplierP = pidProfile->tpa_low_p_rate / (100.0f * pidRuntime.tpaLowBreakpoint);
    pidRuntime.tpaLowMultiplierD = pidProfile->tpa_low_d_rate / (100.0f * pidRuntime.tpaLowBreakpoint);
