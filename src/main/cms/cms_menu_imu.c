...
static const void *cmsx_menuGyro_onEnter(displayPort_t *pDisp)
{
    ...
    cmsx_biquad_response = pidConfig()->biquad_response;
...
static const void *cmsx_menuGyro_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    pidConfigMutable()->biquad_response = cmsx_biquad_response;
...
static const OSD_Entry cmsx_menuFilterGlobalEntries[] =
{
    ...
    { "BQR RSP",   OME_TAB,   NULL, &(OSD_TAB_t){ &cmsx_biquad_response, 1, lookupTableBiquadResponse } },
...
static uint8_t cmsx_dterm_cheby2;
...
static const void *cmsx_FilterPerProfileRead(displayPort_t *pDisp)
{
    ...
    cmsx_dterm_cheby2           = pidProfile->dterm_cheby2;
...
static const void *cmsx_FilterPerProfileWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    pidProfile->dterm_cheby2          = cmsx_dterm_cheby2;
...
static const OSD_Entry cmsx_menuFilterPerProfileEntries[] =
{
    ...
    { "CHEBY2",     OME_TAB,   NULL, &(OSD_TAB_t){ &cmsx_dterm_cheby2, 1, lookupTableOffOn } },
    { "SG WINDOW",  OME_TAB,   NULL, &(OSD_TAB_t){ &cmsx_dterm_sg_window, 4, lookupTableSgWindow } },
