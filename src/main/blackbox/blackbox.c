...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_RC_SMOOTHING_SETPOINT_TYPE, "%d", rxConfig()->rc_smoothing_setpoint_type);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_RC_SMOOTHING_FEEDFORWARD_TYPE, "%d", rxConfig()->rc_smoothing_feedforward_type);
