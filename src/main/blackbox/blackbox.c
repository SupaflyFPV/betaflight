...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_DTERM_DERIVATIVE_TYPE, "%d", currentPidProfile->dterm_derivative_type);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_SG_WINDOW, "%d",      currentPidProfile->dterm_sg_window);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_SG_ORDER, "%d",       currentPidProfile->dterm_sg_order);
