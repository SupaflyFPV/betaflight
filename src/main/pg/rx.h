...
typedef struct rxConfig_s {
    ...
    uint8_t rc_smoothing_cutoff_min;       // Minimum dynamic smoothing cutoff frequency
    uint8_t rc_smoothing_cutoff_max;       // Maximum dynamic smoothing cutoff frequency
    uint8_t rc_smoothing_sensitivity;      // Velocity required to reach max cutoff
