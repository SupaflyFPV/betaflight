...
// PG_PID_PROFILE
    ...
    // When using legacy D-term behaviour, this weight scales the setpoint derivative (0..2000 ~ 0%..200%)
    ...
    // Select BF3.4-style D-term setpoint weighting, which also turns off modern feedforward
