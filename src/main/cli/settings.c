...
// PG_RX_CONFIG
    ...
    { PARAM_NAME_RC_SMOOTHING_SETPOINT_TYPE,      VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_RC_SMOOTHING_FILTER_TYPE }, PG_RX_CONFIG, offsetof(rxConfig_t, rc_smoothing_setpoint_type) },
    { PARAM_NAME_RC_SMOOTHING_FEEDFORWARD_TYPE,   VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_RC_SMOOTHING_FILTER_TYPE }, PG_RX_CONFIG, offsetof(rxConfig_t, rc_smoothing_feedforward_type) },
